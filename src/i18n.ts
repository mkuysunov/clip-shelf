...
const dict = {
  en: {
    ...
    captureHotkey: 'Capture text shortcut',
    captureHint: 'Select an area of the screen — its text and QR codes are copied to the clipboard.',
    ...
    obCapture: (hotkey: string) => `${hotkey} copies text from any area of the screen — even from images and videos.`,
  ...
  ru: {
    ...
    posLeft: 'Слева',
    posRight: 'Справа',
    resizeHint: 'Потяните, чтобы изменить размер панели · двойной клик — сбросить',
    ...
    captureHotkey: 'Сочетание для распознавания текста',
    captureHint: 'Выделите область экрана — её текст и QR-коды окажутся в буфере обмена.',
    ...
    obCapture: (hotkey: string) => `${hotkey} копирует текст с любой области экрана — даже с картинок и видео.`,
